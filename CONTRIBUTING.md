# Contributing to Snatch

## Translations

Snatch ships with 8 languages: English (source), French, German, Spanish, Japanese, Korean, Portuguese (Brazilian), and Chinese (Simplified). Native-speaker refinements via PR are welcome.
...
- **App name** "Snatch" is never translated
